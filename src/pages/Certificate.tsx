...
const certificateTypes = [
  ...
  },
  {
    ...
    description: "for actively contributing to industrial exposure and experience",
  },
];
  ...
  const handleDownloadPdf = async () => {
    try {
      for (const cert of certificateTypes) {
        ...
        const totalWidth = parts.reduce((acc, part) => acc + part.font.widthOfTextAtSize(part.text, courseFontSize), 0);
          ...
          startX += part.font.widthOfTextAtSize(part.text, courseFontSize);
                ...
                if (certificateId) {
                  ...
                  page.drawText(certificateIdText, {
                    x: (page.getWidth() - fontRegular.widthOfTextAtSize(certificateIdText, certificateIdFontSize)) / 2,
                    y: certificateIdY,
  ...
  return (
    <div className="min-h-screen p-8 dark:bg-darkPrimary flex flex-col items-center gap-8">
      ...
      <div className="mt-8 p-4 border-t border-gray-300 w-full ">
        <h2 className="text-xl font-semibold text-gray-700 dark:text-white">Certificate Types</h2>

        {/* Industrial Training Certificate */}
        <div className="mt-4">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-400">Industrial Training Certificate</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
            An Industrial Training Certificate is awarded to students or professionals who successfully complete a short-term, hands-on training program with a company or industry. The training usually focuses on practical exposure to real-world tools, technologies, and processes relevant to their field of study (like IT, engineering, business, etc.).
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 font-semibold">Importance:</p>
          <ul className="list-disc ml-6 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li>Helps bridge the gap between academic knowledge and industry requirements.</li>
            <li>Adds strong value to your resume for jobs or higher studies.</li>
            <li>Shows that you are familiar with industrial practices and workplace professionalism.</li>
          </ul>
        </div>

        {/* Internship Completion Certificate */}
        <div className="mt-4">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-400">Internship Completion Certificate</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
            An Internship Completion Certificate is given after successfully completing an internship, where you work with a company (full-time or part-time) for a certain duration, contributing to actual projects, research, or operations. It highlights your role, contributions, and skills gained during the internship.
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 font-semibold">Importance:</p>
          <ul className="list-disc ml-6 text-sm text-gray-600 dark:text-gray-400">
            <li>Demonstrates real-world work experience and domain knowledge.</li>
            <li>Shows employers that you have professional exposure and can work in teams.</li>
            <li>Boosts your chances during campus placements, job interviews, and career growth.</li>
            <li>Validates your commitment, time management, and adaptability skills.</li>
          </ul>
        </div>
      </div>
      <Button variant="default" onClick={handleDownloadPdf} className="mt-4 p-3 text-white cursor-pointer">
